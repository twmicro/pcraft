package com.twmicro.practical.structures.pieces;
...
public class LegendaryBasePiece {
	
	public static class Piece extends TemplateStructurePiece {
		
		public Piece(TemplateManager templateMgr, CompoundNBT nbt) {
			super(PracticalMod.LEGENDARY_BASE_PIECE, nbt);
		...
		public Piece(TemplateManager templateMgr, ResourceLocation resLoc, BlockPos blockPos, Rotation rot, int offsetY) {
			super(PracticalMod.LEGENDARY_BASE_PIECE, 0);
		...
		private void setupTemplate(TemplateManager templateMgr) {
	         Template template = templateMgr.getTemplateDefaulted(PracticalMod.BASE_LOC);
