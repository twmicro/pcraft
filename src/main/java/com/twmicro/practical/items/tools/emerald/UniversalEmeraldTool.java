...
public class UniversalEmeraldTool extends ToolItem {
    ...
    private static final IItemTier UniversalEmeraldInstrumentTier = new IItemTier()
    {
        @Override
    ...
    public UniversalEmeraldTool() {
        super(9, 0.1F, UniversalEmeraldInstrumentTier, EFFECTIVE_ON, new Properties().group(ItemGroup.TOOLS).addToolType(ToolType.AXE, 5));
    }
