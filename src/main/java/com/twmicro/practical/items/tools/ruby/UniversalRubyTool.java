...
public class UniversalRubyTool extends ToolItem {
    ...
    private static final IItemTier UniversalRubyInstrumentTier = new IItemTier()
    {
        @Override
    ...
    public UniversalRubyTool() {
        super(25, 0.1F, UniversalRubyInstrumentTier, EFFECTIVE_ON, new Properties().group(ItemGroup.TOOLS).addToolType(ToolType.AXE, 5));
    }
    ...
    public float getDestroySpeed(ItemStack stack, BlockState state) {
        ...
        if(type == ToolType.AXE || type == ToolType.SHOVEL || type == ToolType.PICKAXE) return efficiency;
