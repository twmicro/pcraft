package com.twmicro.practical.entities.sensors;

import com.google.common.collect.ImmutableList;
import com.google.common.collect.ImmutableSet;
import com.google.common.collect.Lists;
import com.twmicro.practical.entities.RubyPiglinTasks;
...
public class RubyPiglinMobsSensor extends Sensor<PiglinEntity> {
    ...
    protected void update(ServerWorld worldIn, PiglinEntity entityIn) {
        ...
        for(LivingEntity livingentity : brain.getMemory(MemoryModuleType.VISIBLE_MOBS).orElse(ImmutableList.of())) {
            if (livingentity instanceof HoglinEntity) {
                ...
                if (!optional5.isPresent() && EntityPredicates.field_233583_f_.test(livingentity) && !RubyPiglinTasks.func_234460_a_(playerentity)) {
                    optional5 = Optional.of(playerentity);
                }

                if (!optional6.isPresent() && !playerentity.isSpectator() && RubyPiglinTasks.func_234482_b_(playerentity)) {
                ...
                if (!optional4.isPresent() && RubyPiglinTasks.func_234459_a_(livingentity.getType())) {
