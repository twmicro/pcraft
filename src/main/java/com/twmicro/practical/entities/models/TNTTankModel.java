...
public class TNTTankModel extends EntityModel<TNTTank> {
    ...
    @Override
    public void setRotationAngles(TNTTank entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
