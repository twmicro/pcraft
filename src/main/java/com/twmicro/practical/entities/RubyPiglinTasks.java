...
public class RubyPiglinTasks {
    public static final Item field_234444_a_ = ModItems.RUBY_INGOT;
    ...
    private static void func_234464_a_(Brain<PiglinEntity> p_234464_0_) {
        p_234464_0_.func_233698_a_(Activity.CORE, 0, ImmutableList.<net.minecraft.entity.ai.brain.task.Task<? super PiglinEntity>>of(new LookTask(45, 90), new WalkToTargetTask(200), new InteractWithDoorTask(), func_241428_d_(), func_234500_d_(), new StartAdmiringItemTask(), new AdmireItemTask(120), new EndAttackTask(300, RubyPiglinTasks::func_234461_a_), new GetAngryTask()));
    }

    private static void func_234485_b_(Brain<PiglinEntity> p_234485_0_) {
        Method method = null;
        try {
            method = PiglinEntity.class.getDeclaredMethod("func_234422_eK_");
        } catch (NoSuchMethodException e) {
            e.printStackTrace();
        }
        method.setAccessible(true);
        Method finalMethod = method;
        p_234485_0_.func_233698_a_(Activity.IDLE, 10, ImmutableList.of(new LookAtEntityTask(RubyPiglinTasks::func_234482_b_, 14.0F), new ForgetAttackTargetTask<>(PiglinEntity::func_234421_eJ_, RubyPiglinTasks::func_234526_m_), new StartHuntTask<>(), func_234493_c_(), func_234505_e_(), func_234458_a_(), func_234481_b_(), new FindInteractionAndLookTargetTask(EntityType.PLAYER, 4)));
    }

    private static void func_234488_b_(PiglinEntity p_234488_0_, Brain<PiglinEntity> p_234488_1_) {
        p_234488_1_.func_233699_a_(Activity.field_234621_k_, 10, ImmutableList.<net.minecraft.entity.ai.brain.task.Task<? super PiglinEntity>>of(new FindNewAttackTargetTask<>((p_234523_1_) -> !func_234504_d_(p_234488_0_, p_234523_1_)), new SupplementedTask<>(RubyPiglinTasks::func_234494_c_, new AttackStrafingTask<>(5, 0.75F)), new MoveToTargetTask(1.0F), new AttackTargetTask(20), new ShootTargetTask(), new FinishedHuntTask(), new PredicateTask<>(RubyPiglinTasks::func_234525_l_, MemoryModuleType.field_234103_o_)), MemoryModuleType.field_234103_o_);
    }

    private static void func_234495_c_(Brain<PiglinEntity> p_234495_0_) {
        p_234495_0_.func_233699_a_(Activity.field_234622_l_, 10, ImmutableList.<net.minecraft.entity.ai.brain.task.Task<? super PiglinEntity>>of(func_234493_c_(), new LookAtEntityTask(RubyPiglinTasks::func_234482_b_, 14.0F), new ForgetAttackTargetTask<PiglinEntity>(PiglinEntity::func_234421_eJ_, RubyPiglinTasks::func_234526_m_), new SupplementedTask<PiglinEntity>((p_234457_0_) -> {
    ...
    private static void func_234502_d_(Brain<PiglinEntity> p_234502_0_) {
        p_234502_0_.func_233699_a_(Activity.field_234623_m_, 10, ImmutableList.<net.minecraft.entity.ai.brain.task.Task<? super PiglinEntity>>of(new PickupWantedItemTask<>(RubyPiglinTasks::func_234455_E_, 1.0F, true, 9), new ForgetAdmiredItemTask(9)), MemoryModuleType.field_234080_N_);
    }

    private static void func_234507_e_(Brain<PiglinEntity> p_234507_0_) {
        p_234507_0_.func_233699_a_(Activity.field_234624_n_, 10, ImmutableList.of(RunAwayTask.func_233965_b_(MemoryModuleType.field_234106_z_, 1.0F, 12, true), func_234458_a_(), func_234481_b_(), new PredicateTask<PiglinEntity>(RubyPiglinTasks::func_234533_t_, MemoryModuleType.field_234106_z_)), MemoryModuleType.field_234106_z_);
    }

    private static void func_234511_f_(Brain<PiglinEntity> p_234511_0_) {
        p_234511_0_.func_233699_a_(Activity.field_234625_o_, 10, ImmutableList.of(new RideEntityTask<>(0.8F), new LookAtEntityTask(RubyPiglinTasks::func_234482_b_, 8.0F), new SupplementedTask<>(Entity::isPassenger, func_234458_a_()), new StopRidingEntityTask<>(8, RubyPiglinTasks::func_234467_a_)), MemoryModuleType.field_234105_s_);
    }
    ...
    private static FirstShuffledTask<PiglinEntity> func_234481_b_() {
        return new FirstShuffledTask<>(ImmutableList.of(Pair.of(new WalkRandomlyTask(0.6F), 2), Pair.of(InteractWithEntityTask.func_220445_a(EntityType.field_233591_ai_, 8, MemoryModuleType.INTERACTION_TARGET, 0.6F, 2), 2), Pair.of(new SupplementedTask<>(RubyPiglinTasks::func_234514_g_, new WalkTowardsLookTargetTask(0.6F, 3)), 2), Pair.of(new DummyTask(30, 60), 1)));
    }
    ...
    private static PiglinIdleActivityTask<PiglinEntity, LivingEntity> func_234500_d_() {
        return new PiglinIdleActivityTask<>(RubyPiglinTasks::func_234525_l_, MemoryModuleType.field_234093_aa_, MemoryModuleType.field_234106_z_, field_234449_f_);
    }
    ...
    protected static void func_234486_b_(PiglinEntity p_234486_0_)
    {
        ...
        if (activity != activity1) {
            func_241429_d_(p_234486_0_).ifPresent(((RubyPiglinEntity)p_234486_0_)::func_241417_a_);
        }
    ...
    private static void func_241427_c_(PiglinEntity p_241427_0_, ItemStack p_241427_1_) {
        ...
        ((RubyPiglinEntity)p_241427_0_).func_234439_n_(p_241427_1_);
    }
    ...
    protected static void func_234477_a_(PiglinEntity p_234477_0_, boolean p_234477_1_) {
        ...
        if (p_234477_0_.func_234421_eJ_()) {
            ...
            if (!flag2) {
                ...
                ((RubyPiglinEntity)p_234477_0_).func_234438_m_(itemstack);
            }
        }
    ...
    private static void func_234498_c_(PiglinEntity p_234498_0_, ItemStack p_234498_1_) {
        ItemStack itemstack = ((RubyPiglinEntity)p_234498_0_).func_234436_k_(p_234498_1_);
    ...
    private static List<ItemStack> func_234524_k_(PiglinEntity p_234524_0_) {
        ...
        LootTable loottable = p_234524_0_.world.getServer().getLootTableManager().getLootTableFromLocation(new ResourceLocation("practical", "barters/ruby_piglin_barter"));
    ...
    protected static boolean func_234474_a_(PiglinEntity p_234474_0_, ItemStack p_234474_1_) {
        ...
        if (item.isIn(ItemTags.field_232902_M_)) {
            ...
            boolean flag = ((RubyPiglinEntity)p_234474_0_).func_234437_l_(p_234474_1_);
            if (item == Items.GOLD_NUGGET) {
                return flag;
            } else if (func_234499_c_(item)) {
                return !func_234538_z_(p_234474_0_) && flag;
            } else if (!func_234480_a_(item)) {
                return ((RubyPiglinEntity)p_234474_0_).func_234440_o_(p_234474_1_);
            } else {
    ...
    public static void func_234478_a_(PlayerEntity p_234478_0_, boolean p_234478_1_) {
        ...
        list.stream().filter(RubyPiglinTasks::func_234520_i_).filter((p_234491_2_) -> {
    ...
    public static boolean func_234460_a_(LivingEntity p_234460_0_) {
        for(ItemStack itemstack : p_234460_0_.getArmorInventoryList()) {
            Item item = itemstack.getItem();
            if (item instanceof ArmorItem && ((ArmorItem)item).getArmorMaterial() == ModArmorMaterials.RUBY_ARMOR_MATERIAL) {
                return true;
            }
        }
    ...
    protected static void func_241430_f_(PiglinEntity p_241430_0_) {
        func_234530_q_(p_241430_0_).forEach((p_241419_0_) -> {
            func_241432_i_((PiglinEntity) p_241419_0_).ifPresent((p_241421_1_) -> {
                func_234497_c_((PiglinEntity) p_241419_0_, p_241421_1_);
            });
        });
    }

    protected static void func_234512_f_(PiglinEntity p_234512_0_) {
        ArrayList<PiglinEntity> list = new ArrayList<>();
        func_234529_p_(p_234512_0_).forEach((piglin) -> list.add((PiglinEntity) piglin));
        list.forEach(RubyPiglinTasks::func_234518_h_);
    }
    ...
    public static boolean func_234482_b_(LivingEntity p_234482_0_) {
        return p_234482_0_.getType() == EntityType.PLAYER && p_234482_0_.func_233634_a_(RubyPiglinTasks::func_234480_a_);
    }
